// Generated by gencpp from file lidar/CoreInfo.msg
// DO NOT EDIT!


#ifndef LIDAR_MESSAGE_COREINFO_H
#define LIDAR_MESSAGE_COREINFO_H
...
struct CoreInfo_
{
  ...
  _exist_confidence_type exist_confidence;
   ...
   typedef  ::lidar::Point3f_<ContainerAllocator>  _center_type;
  _center_type center;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _center_cov_type;
  _center_cov_type center_cov;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _size_type;
  _size_type size;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _size_cov_type;
  _size_cov_type size_cov;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _direction_type;
  _direction_type direction;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _direction_cov_type;
  ...
  _age_type age;
   ...
   typedef  ::lidar::Point3f_<ContainerAllocator>  _velocity_type;
  _velocity_type velocity;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _velocity_cov_type;
  _velocity_cov_type velocity_cov;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _acceleration_type;
  _acceleration_type acceleration;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _acceleration_cov_type;
  ...
  _angle_acceleration_cov_type angle_acceleration_cov;
   ...
   typedef  ::lidar::Point3f_<ContainerAllocator>  _anchor_type;
  _anchor_type anchor;

   typedef  ::lidar::Point3f_<ContainerAllocator>  _nearest_point_type;
  ...
  typedef boost::shared_ptr< ::lidar::CoreInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lidar::CoreInfo_<ContainerAllocator> const> ConstPtr;

}; // struct CoreInfo_

typedef ::lidar::CoreInfo_<std::allocator<void> > CoreInfo;

typedef boost::shared_ptr< ::lidar::CoreInfo > CoreInfoPtr;
typedef boost::shared_ptr< ::lidar::CoreInfo const> CoreInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lidar::CoreInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lidar::CoreInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::lidar::CoreInfo_<ContainerAllocator1> & lhs, const ::lidar::CoreInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::lidar::CoreInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lidar::CoreInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lidar::CoreInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lidar::CoreInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lidar::CoreInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lidar::CoreInfo_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lidar::CoreInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lidar::CoreInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7f0ff990bf278ab8ULL;
  static const uint64_t static_value2 = 0x7b544233b3a79e70ULL;
};

template<class ContainerAllocator>
struct DataType< ::lidar::CoreInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::lidar::CoreInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lidar::CoreInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lidar::CoreInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lidar::CoreInfo_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
    s << std::endl;
    ...
    s << indent << "center: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.center);
    s << indent << "center_cov: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.center_cov);
    s << indent << "size: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.size);
    s << indent << "size_cov: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.size_cov);
    s << indent << "direction: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.direction);
    s << indent << "direction_cov: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.direction_cov);
    s << indent << "type: ";
    s << std::endl;
    ...
    s << indent << "velocity: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.velocity);
    s << indent << "velocity_cov: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.velocity_cov);
    s << indent << "acceleration: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.acceleration);
    s << indent << "acceleration_cov: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.acceleration_cov);
    ...
    s << indent << "anchor: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.anchor);
    s << indent << "nearest_point: ";
    s << std::endl;
    Printer< ::lidar::Point3f_<ContainerAllocator> >::stream(s, indent + "  ", v.nearest_point);
  }
};
...
#endif // LIDAR_MESSAGE_COREINFO_H
