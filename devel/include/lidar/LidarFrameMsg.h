// Generated by gencpp from file lidar/LidarFrameMsg.msg
// DO NOT EDIT!


#ifndef LIDAR_MESSAGE_LIDARFRAMEMSG_H
#define LIDAR_MESSAGE_LIDARFRAMEMSG_H
...
#include <lidar/Point3d.h>
#include <lidar/PoseMap.h>
#include <std_msgs/Int32.h>
#include <lidar/Indices.h>
#include <lidar/Objects.h>
#include <std_msgs/Bool.h>
#include <lidar/Point4f.h>
#include <std_msgs/Bool.h>
#include <lidar/Objects.h>
#include <std_msgs/Bool.h>
#include <lidar/FreeSpaceInfos.h>
#include <std_msgs/Bool.h>
#include <lidar/Lanes.h>
#include <std_msgs/Bool.h>
#include <lidar/RoadEdges.h>
#include <std_msgs/Bool.h>
#include <lidar/Indices.h>
#include <lidar/Indices.h>
#include <lidar/Indices.h>
...
struct LidarFrameMsg_
{
  ...
  _timestamp_type timestamp;
   ...
   typedef  ::lidar::Pose_<ContainerAllocator>  _global_pose_type;
  _global_pose_type global_pose;

   typedef  ::lidar::Point3d_<ContainerAllocator>  _gps_origin_type;
  _gps_origin_type gps_origin;

   typedef  ::lidar::PoseMap_<ContainerAllocator>  _status_pose_map_type;
  _status_pose_map_type status_pose_map;

   typedef  ::std_msgs::Int32_<ContainerAllocator>  _status_type;
  _status_type status;

   typedef  ::lidar::Indices_<ContainerAllocator>  _valid_indices_type;
  _valid_indices_type valid_indices;

   typedef  ::lidar::Objects_<ContainerAllocator>  _objects_type;
  _objects_type objects;

   typedef  ::std_msgs::Bool_<ContainerAllocator>  _has_pointcloud_type;
  _has_pointcloud_type has_pointcloud;

   typedef std::vector< ::lidar::Point4f_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::lidar::Point4f_<ContainerAllocator> >> _scan_pointcloud_type;
  ...
  _has_attention_objects_type has_attention_objects;
   ...
   typedef  ::lidar::Objects_<ContainerAllocator>  _attention_objects_type;
  ...
  _has_sematice_indices_type has_sematice_indices;
   ...
   typedef  ::lidar::Indices_<ContainerAllocator>  _non_ground_indices_type;
  _non_ground_indices_type non_ground_indices;

   typedef  ::lidar::Indices_<ContainerAllocator>  _ground_indices_type;
  _ground_indices_type ground_indices;

   typedef  ::lidar::Indices_<ContainerAllocator>  _background_indices_type;
  ...
  typedef boost::shared_ptr< ::lidar::LidarFrameMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lidar::LidarFrameMsg_<ContainerAllocator> const> ConstPtr;

}; // struct LidarFrameMsg_

typedef ::lidar::LidarFrameMsg_<std::allocator<void> > LidarFrameMsg;

typedef boost::shared_ptr< ::lidar::LidarFrameMsg > LidarFrameMsgPtr;
typedef boost::shared_ptr< ::lidar::LidarFrameMsg const> LidarFrameMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lidar::LidarFrameMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lidar::LidarFrameMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::lidar::LidarFrameMsg_<ContainerAllocator1> & lhs, const ::lidar::LidarFrameMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::lidar::LidarFrameMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lidar::LidarFrameMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lidar::LidarFrameMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lidar::LidarFrameMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lidar::LidarFrameMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lidar::LidarFrameMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lidar::LidarFrameMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lidar::LidarFrameMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcaa4cd6acb7dc86fULL;
  static const uint64_t static_value2 = 0x4a76180c583c5946ULL;
};

template<class ContainerAllocator>
struct DataType< ::lidar::LidarFrameMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::lidar::LidarFrameMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lidar::LidarFrameMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lidar::LidarFrameMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lidar::LidarFrameMsg_<ContainerAllocator>& v)
  {
    s << indent << "frame_id: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::lidar::Pose_<ContainerAllocator> >::stream(s, indent + "  ", v.global_pose);
    s << indent << "gps_origin: ";
    s << std::endl;
    Printer< ::lidar::Point3d_<ContainerAllocator> >::stream(s, indent + "  ", v.gps_origin);
    s << indent << "status_pose_map: ";
    s << std::endl;
    Printer< ::lidar::PoseMap_<ContainerAllocator> >::stream(s, indent + "  ", v.status_pose_map);
    s << indent << "status: ";
    s << std::endl;
    Printer< ::std_msgs::Int32_<ContainerAllocator> >::stream(s, indent + "  ", v.status);
    s << indent << "valid_indices: ";
    s << std::endl;
    Printer< ::lidar::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.valid_indices);
    s << indent << "objects: ";
    s << std::endl;
    Printer< ::lidar::Objects_<ContainerAllocator> >::stream(s, indent + "  ", v.objects);
    ...
    for (size_t i = 0; i < v.scan_pointcloud.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::lidar::Point4f_<ContainerAllocator> >::stream(s, indent + "    ", v.scan_pointcloud[i]);
    }
    ...
    s << std::endl;
    Printer< ::lidar::Objects_<ContainerAllocator> >::stream(s, indent + "  ", v.attention_objects);
    s << indent << "has_freespace: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.has_freespace);
    s << indent << "freespace_infos: ";
    s << std::endl;
    Printer< ::lidar::FreeSpaceInfos_<ContainerAllocator> >::stream(s, indent + "  ", v.freespace_infos);
    s << indent << "has_lanes: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.has_lanes);
    s << indent << "lanes: ";
    s << std::endl;
    Printer< ::lidar::Lanes_<ContainerAllocator> >::stream(s, indent + "  ", v.lanes);
    s << indent << "has_roadedges: ";
    s << std::endl;
    Printer< ::std_msgs::Bool_<ContainerAllocator> >::stream(s, indent + "  ", v.has_roadedges);
    s << indent << "roadedges: ";
    s << std::endl;
    Printer< ::lidar::RoadEdges_<ContainerAllocator> >::stream(s, indent + "  ", v.roadedges);
    ...
    s << std::endl;
    Printer< ::lidar::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.non_ground_indices);
    s << indent << "ground_indices: ";
    s << std::endl;
    Printer< ::lidar::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.ground_indices);
    s << indent << "background_indices: ";
    s << std::endl;
    Printer< ::lidar::Indices_<ContainerAllocator> >::stream(s, indent + "  ", v.background_indices);
  }
};
...
#endif // LIDAR_MESSAGE_LIDARFRAMEMSG_H
