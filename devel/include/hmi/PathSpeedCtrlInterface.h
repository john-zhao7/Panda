// Generated by gencpp from file hmi/PathSpeedCtrlInterface.msg
// DO NOT EDIT!


#ifndef HMI_MESSAGE_PATHSPEEDCTRLINTERFACE_H
#define HMI_MESSAGE_PATHSPEEDCTRLINTERFACE_H
...
struct PathSpeedCtrlInterface_
{
  ...
  typedef boost::shared_ptr< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> const> ConstPtr;

}; // struct PathSpeedCtrlInterface_

typedef ::hmi::PathSpeedCtrlInterface_<std::allocator<void> > PathSpeedCtrlInterface;

typedef boost::shared_ptr< ::hmi::PathSpeedCtrlInterface > PathSpeedCtrlInterfacePtr;
typedef boost::shared_ptr< ::hmi::PathSpeedCtrlInterface const> PathSpeedCtrlInterfaceConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::hmi::PathSpeedCtrlInterface_<ContainerAllocator1> & lhs, const ::hmi::PathSpeedCtrlInterface_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
{
  ...
  static const char* value(const ::hmi::PathSpeedCtrlInterface_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa552e8162979c20bULL;
  static const uint64_t static_value2 = 0x671aaee207815dbeULL;
};

template<class ContainerAllocator>
struct DataType< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::hmi::PathSpeedCtrlInterface_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::hmi::PathSpeedCtrlInterface_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
...
#endif // HMI_MESSAGE_PATHSPEEDCTRLINTERFACE_H
