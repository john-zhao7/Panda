...
class RoadEdge {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('roadedge_id')) {
        this.roadedge_id = initObj.roadedge_id
      }
      else {
        this.roadedge_id = new std_msgs.msg.Int32();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [roadedge_id]
    bufferOffset = std_msgs.msg.Int32.serialize(obj.roadedge_id, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RoadEdge(null);
    // Deserialize message field [roadedge_id]
    data.roadedge_id = std_msgs.msg.Int32.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RoadEdge(null);
    if (msg.roadedge_id !== undefined) {
      resolved.roadedge_id = std_msgs.msg.Int32.Resolve(msg.roadedge_id)
    }
    else {
      resolved.roadedge_id = new std_msgs.msg.Int32()
    }
