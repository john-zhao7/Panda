...
(cl:defmethod lidar_start-val ((m <FaultDiagnosisInterface>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_interfaces-msg:lidar_start-val is deprecated.  Use car_interfaces-msg:lidar_start instead.")
  (lidar_start m))

(cl:ensure-generic-function 'Gps_state_fault-val :lambda-list '(m))
(cl:defmethod Gps_state_fault-val ((m <FaultDiagnosisInterface>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader car_interfaces-msg:Gps_state_fault-val is deprecated.  Use car_interfaces-msg:Gps_state_fault instead.")
  (Gps_state_fault m))
