...
(cl:defmethod cl:initialize-instance :after ((m <HmiStartEndPointInterface>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HmiStartEndPointInterface)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hmi-msg:<HmiStartEndPointInterface> is deprecated: use hmi-msg:HmiStartEndPointInterface instead.")))
...
(cl:defmethod roadid-val ((m <HmiStartEndPointInterface>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmi-msg:roadid-val is deprecated.  Use hmi-msg:roadid instead.")
  (roadid m))

(cl:ensure-generic-function 'stationid-val :lambda-list '(m))
(cl:defmethod stationid-val ((m <HmiStartEndPointInterface>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmi-msg:stationid-val is deprecated.  Use hmi-msg:stationid instead.")
  (stationid m))
