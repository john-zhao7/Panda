...
(cl:defmethod cl:initialize-instance :after ((m <AxisStatusPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AxisStatusPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<AxisStatusPose> is deprecated: use lidar-msg:AxisStatusPose instead.")))
...
(cl:defmethod pose-val ((m <AxisStatusPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:pose-val is deprecated.  Use lidar-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AxisStatusPose>)))
  ...
  (cl:format cl:nil "std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: lidar/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AxisStatusPose)))
  "Returns full string definition for message of type 'AxisStatusPose"
  (cl:format cl:nil "std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: lidar/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
