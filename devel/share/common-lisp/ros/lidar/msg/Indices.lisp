...
(cl:defmethod cl:initialize-instance :after ((m <Indices>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Indices)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<Indices> is deprecated: use lidar-msg:Indices instead.")))

(cl:ensure-generic-function 'indices-val :lambda-list '(m))
(cl:defmethod indices-val ((m <Indices>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:indices-val is deprecated.  Use lidar-msg:indices instead.")
  (indices m))
