...
(cl:defclass <LidarFrameMsg> (roslisp-msg-protocol:ros-message)
  ((frame_id
   ...
   (global_pose
    ...
    :initarg :global_pose
    :type lidar-msg:Pose
    :initform (cl:make-instance 'lidar-msg:Pose))
   (gps_origin
    :reader gps_origin
    :initarg :gps_origin
    :type lidar-msg:Point3d
    :initform (cl:make-instance 'lidar-msg:Point3d))
   (status_pose_map
    :reader status_pose_map
    :initarg :status_pose_map
    :type lidar-msg:PoseMap
    :initform (cl:make-instance 'lidar-msg:PoseMap))
   (status
    :reader status
    :initarg :status
   ...
   (valid_indices
    ...
    :type lidar-msg:Indices
    :initform (cl:make-instance 'lidar-msg:Indices))
   (objects
    :reader objects
    :initarg :objects
    :type lidar-msg:Objects
    :initform (cl:make-instance 'lidar-msg:Objects))
   (has_pointcloud
   ...
   (scan_pointcloud
    ...
    :type (cl:vector lidar-msg:Point4f)
   :initform (cl:make-array 0 :element-type 'lidar-msg:Point4f :initial-element (cl:make-instance 'lidar-msg:Point4f)))
   ...
   (freespace_infos
    ...
    :type lidar-msg:FreeSpaceInfos
    :initform (cl:make-instance 'lidar-msg:FreeSpaceInfos))
   (has_lanes
    :reader has_lanes
    :initarg :has_lanes
    :type std_msgs-msg:Bool
   ...
   (lanes
    :reader lanes
    :initarg :lanes
    :type lidar-msg:Lanes
    :initform (cl:make-instance 'lidar-msg:Lanes))
   (has_roadedges
   ...
   (roadedges
    :reader roadedges
    :initarg :roadedges
    :type lidar-msg:RoadEdges
    :initform (cl:make-instance 'lidar-msg:RoadEdges))
...
(cl:defmethod cl:initialize-instance :after ((m <LidarFrameMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LidarFrameMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<LidarFrameMsg> is deprecated: use lidar-msg:LidarFrameMsg instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:frame_id-val is deprecated.  Use lidar-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:timestamp-val is deprecated.  Use lidar-msg:timestamp instead.")
  (timestamp m))

(cl:ensure-generic-function 'global_pose-val :lambda-list '(m))
(cl:defmethod global_pose-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:global_pose-val is deprecated.  Use lidar-msg:global_pose instead.")
  (global_pose m))

(cl:ensure-generic-function 'gps_origin-val :lambda-list '(m))
(cl:defmethod gps_origin-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:gps_origin-val is deprecated.  Use lidar-msg:gps_origin instead.")
  (gps_origin m))

(cl:ensure-generic-function 'status_pose_map-val :lambda-list '(m))
(cl:defmethod status_pose_map-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:status_pose_map-val is deprecated.  Use lidar-msg:status_pose_map instead.")
  (status_pose_map m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:status-val is deprecated.  Use lidar-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'valid_indices-val :lambda-list '(m))
(cl:defmethod valid_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:valid_indices-val is deprecated.  Use lidar-msg:valid_indices instead.")
  (valid_indices m))

(cl:ensure-generic-function 'objects-val :lambda-list '(m))
(cl:defmethod objects-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:objects-val is deprecated.  Use lidar-msg:objects instead.")
  (objects m))

(cl:ensure-generic-function 'has_pointcloud-val :lambda-list '(m))
(cl:defmethod has_pointcloud-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:has_pointcloud-val is deprecated.  Use lidar-msg:has_pointcloud instead.")
  (has_pointcloud m))

(cl:ensure-generic-function 'scan_pointcloud-val :lambda-list '(m))
(cl:defmethod scan_pointcloud-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:scan_pointcloud-val is deprecated.  Use lidar-msg:scan_pointcloud instead.")
  (scan_pointcloud m))

(cl:ensure-generic-function 'has_attention_objects-val :lambda-list '(m))
(cl:defmethod has_attention_objects-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:has_attention_objects-val is deprecated.  Use lidar-msg:has_attention_objects instead.")
...
(cl:defmethod attention_objects-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:attention_objects-val is deprecated.  Use lidar-msg:attention_objects instead.")
  (attention_objects m))

(cl:ensure-generic-function 'has_freespace-val :lambda-list '(m))
(cl:defmethod has_freespace-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:has_freespace-val is deprecated.  Use lidar-msg:has_freespace instead.")
  (has_freespace m))

(cl:ensure-generic-function 'freespace_infos-val :lambda-list '(m))
(cl:defmethod freespace_infos-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:freespace_infos-val is deprecated.  Use lidar-msg:freespace_infos instead.")
  (freespace_infos m))

(cl:ensure-generic-function 'has_lanes-val :lambda-list '(m))
(cl:defmethod has_lanes-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:has_lanes-val is deprecated.  Use lidar-msg:has_lanes instead.")
  (has_lanes m))

(cl:ensure-generic-function 'lanes-val :lambda-list '(m))
(cl:defmethod lanes-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:lanes-val is deprecated.  Use lidar-msg:lanes instead.")
  (lanes m))

(cl:ensure-generic-function 'has_roadedges-val :lambda-list '(m))
(cl:defmethod has_roadedges-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:has_roadedges-val is deprecated.  Use lidar-msg:has_roadedges instead.")
  (has_roadedges m))

(cl:ensure-generic-function 'roadedges-val :lambda-list '(m))
(cl:defmethod roadedges-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:roadedges-val is deprecated.  Use lidar-msg:roadedges instead.")
  (roadedges m))

(cl:ensure-generic-function 'has_sematice_indices-val :lambda-list '(m))
(cl:defmethod has_sematice_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:has_sematice_indices-val is deprecated.  Use lidar-msg:has_sematice_indices instead.")
...
(cl:defmethod non_ground_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:non_ground_indices-val is deprecated.  Use lidar-msg:non_ground_indices instead.")
...
(cl:defmethod ground_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:ground_indices-val is deprecated.  Use lidar-msg:ground_indices instead.")
  (ground_indices m))

(cl:ensure-generic-function 'background_indices-val :lambda-list '(m))
(cl:defmethod background_indices-val ((m <LidarFrameMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:background_indices-val is deprecated.  Use lidar-msg:background_indices instead.")
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LidarFrameMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'scan_pointcloud)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar-msg:Point4f))
