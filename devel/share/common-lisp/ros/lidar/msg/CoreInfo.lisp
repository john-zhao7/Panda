...
(cl:defclass <CoreInfo> (roslisp-msg-protocol:ros-message)
  ((timestamp
   ...
   (center
    :reader center
    :initarg :center
    :type lidar-msg:Point3f
    :initform (cl:make-instance 'lidar-msg:Point3f))
   (center_cov
    :reader center_cov
    :initarg :center_cov
    :type lidar-msg:Point3f
...
(cl:defmethod cl:initialize-instance :after ((m <CoreInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CoreInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<CoreInfo> is deprecated: use lidar-msg:CoreInfo instead.")))
...
(cl:defmethod priority_id-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:priority_id-val is deprecated.  Use lidar-msg:priority_id instead.")
  (priority_id m))

(cl:ensure-generic-function 'exist_confidence-val :lambda-list '(m))
(cl:defmethod exist_confidence-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:exist_confidence-val is deprecated.  Use lidar-msg:exist_confidence instead.")
  (exist_confidence m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:center-val is deprecated.  Use lidar-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'center_cov-val :lambda-list '(m))
(cl:defmethod center_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:center_cov-val is deprecated.  Use lidar-msg:center_cov instead.")
  (center_cov m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:size-val is deprecated.  Use lidar-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'size_cov-val :lambda-list '(m))
(cl:defmethod size_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:size_cov-val is deprecated.  Use lidar-msg:size_cov instead.")
  (size_cov m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:direction-val is deprecated.  Use lidar-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'direction_cov-val :lambda-list '(m))
(cl:defmethod direction_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:direction_cov-val is deprecated.  Use lidar-msg:direction_cov instead.")
  (direction_cov m))
...
(cl:defmethod type_confidence-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:type_confidence-val is deprecated.  Use lidar-msg:type_confidence instead.")
  (type_confidence m))
...
(cl:defmethod lane_pos-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:lane_pos-val is deprecated.  Use lidar-msg:lane_pos instead.")
  (lane_pos m))

(cl:ensure-generic-function 'trakcer_id-val :lambda-list '(m))
(cl:defmethod trakcer_id-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:trakcer_id-val is deprecated.  Use lidar-msg:trakcer_id instead.")
  (trakcer_id m))
...
(cl:defmethod velocity-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:velocity-val is deprecated.  Use lidar-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'velocity_cov-val :lambda-list '(m))
(cl:defmethod velocity_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:velocity_cov-val is deprecated.  Use lidar-msg:velocity_cov instead.")
  (velocity_cov m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:acceleration-val is deprecated.  Use lidar-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'acceleration_cov-val :lambda-list '(m))
(cl:defmethod acceleration_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:acceleration_cov-val is deprecated.  Use lidar-msg:acceleration_cov instead.")
  (acceleration_cov m))

(cl:ensure-generic-function 'angle_velocity-val :lambda-list '(m))
(cl:defmethod angle_velocity-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:angle_velocity-val is deprecated.  Use lidar-msg:angle_velocity instead.")
  (angle_velocity m))

(cl:ensure-generic-function 'angle_velocity_cov-val :lambda-list '(m))
(cl:defmethod angle_velocity_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:angle_velocity_cov-val is deprecated.  Use lidar-msg:angle_velocity_cov instead.")
...
(cl:defmethod angle_acceleration-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:angle_acceleration-val is deprecated.  Use lidar-msg:angle_acceleration instead.")
...
(cl:defmethod angle_acceleration_cov-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:angle_acceleration_cov-val is deprecated.  Use lidar-msg:angle_acceleration_cov instead.")
  (angle_acceleration_cov m))

(cl:ensure-generic-function 'anchor-val :lambda-list '(m))
(cl:defmethod anchor-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:anchor-val is deprecated.  Use lidar-msg:anchor instead.")
  (anchor m))

(cl:ensure-generic-function 'nearest_point-val :lambda-list '(m))
(cl:defmethod nearest_point-val ((m <CoreInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:nearest_point-val is deprecated.  Use lidar-msg:nearest_point instead.")
  (nearest_point m))
