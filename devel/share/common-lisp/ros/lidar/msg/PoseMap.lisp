...
(cl:defclass <PoseMap> (roslisp-msg-protocol:ros-message)
  ((status_poses
    ...
    :type (cl:vector lidar-msg:AxisStatusPose)
   :initform (cl:make-array 0 :element-type 'lidar-msg:AxisStatusPose :initial-element (cl:make-instance 'lidar-msg:AxisStatusPose))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PoseMap>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseMap)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<PoseMap> is deprecated: use lidar-msg:PoseMap instead.")))

(cl:ensure-generic-function 'status_poses-val :lambda-list '(m))
(cl:defmethod status_poses-val ((m <PoseMap>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:status_poses-val is deprecated.  Use lidar-msg:status_poses instead.")
  (status_poses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PoseMap>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'status_poses)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar-msg:AxisStatusPose))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PoseMap>)))
  ...
  (cl:format cl:nil "AxisStatusPose[] status_poses ~%~%================================================================================~%MSG: lidar/AxisStatusPose~%std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: lidar/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PoseMap)))
  "Returns full string definition for message of type 'PoseMap"
  (cl:format cl:nil "AxisStatusPose[] status_poses ~%~%================================================================================~%MSG: lidar/AxisStatusPose~%std_msgs/Int32 status ~%Pose           pose ~%================================================================================~%MSG: std_msgs/Int32~%int32 data~%================================================================================~%MSG: lidar/Pose~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%~%std_msgs/Float32 roll ~%std_msgs/Float32 pitch~%std_msgs/Float32 yaw~%~%std_msgs/Int32 status ~%~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
