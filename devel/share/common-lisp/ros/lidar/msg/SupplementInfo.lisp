...
(cl:defclass <SupplementInfo> (roslisp-msg-protocol:ros-message)
  ((unique_id
   ...
   (polygon
    :reader polygon
    :initarg :polygon
    :type (cl:vector lidar-msg:Point3f)
   :initform (cl:make-array 0 :element-type 'lidar-msg:Point3f :initial-element (cl:make-instance 'lidar-msg:Point3f)))
   (left_point_index
...
(cl:defmethod cl:initialize-instance :after ((m <SupplementInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SupplementInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<SupplementInfo> is deprecated: use lidar-msg:SupplementInfo instead.")))

(cl:ensure-generic-function 'unique_id-val :lambda-list '(m))
(cl:defmethod unique_id-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:unique_id-val is deprecated.  Use lidar-msg:unique_id instead.")
  (unique_id m))

(cl:ensure-generic-function 'polygon-val :lambda-list '(m))
(cl:defmethod polygon-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:polygon-val is deprecated.  Use lidar-msg:polygon instead.")
  (polygon m))

(cl:ensure-generic-function 'left_point_index-val :lambda-list '(m))
(cl:defmethod left_point_index-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:left_point_index-val is deprecated.  Use lidar-msg:left_point_index instead.")
  (left_point_index m))

(cl:ensure-generic-function 'right_point_index-val :lambda-list '(m))
(cl:defmethod right_point_index-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:right_point_index-val is deprecated.  Use lidar-msg:right_point_index instead.")
  (right_point_index m))

(cl:ensure-generic-function 'cloud_indices-val :lambda-list '(m))
(cl:defmethod cloud_indices-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:cloud_indices-val is deprecated.  Use lidar-msg:cloud_indices instead.")
  (cloud_indices m))

(cl:ensure-generic-function 'latent_types-val :lambda-list '(m))
(cl:defmethod latent_types-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:latent_types-val is deprecated.  Use lidar-msg:latent_types instead.")
  (latent_types m))

(cl:ensure-generic-function 'size_type-val :lambda-list '(m))
(cl:defmethod size_type-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:size_type-val is deprecated.  Use lidar-msg:size_type instead.")
  (size_type m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:mode-val is deprecated.  Use lidar-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'in_roi-val :lambda-list '(m))
(cl:defmethod in_roi-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:in_roi-val is deprecated.  Use lidar-msg:in_roi instead.")
  (in_roi m))

(cl:ensure-generic-function 'tracking_state-val :lambda-list '(m))
(cl:defmethod tracking_state-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:tracking_state-val is deprecated.  Use lidar-msg:tracking_state instead.")
  (tracking_state m))

(cl:ensure-generic-function 'geo_center-val :lambda-list '(m))
(cl:defmethod geo_center-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:geo_center-val is deprecated.  Use lidar-msg:geo_center instead.")
  (geo_center m))

(cl:ensure-generic-function 'geo_size-val :lambda-list '(m))
(cl:defmethod geo_size-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:geo_size-val is deprecated.  Use lidar-msg:geo_size instead.")
  (geo_size m))

(cl:ensure-generic-function 'trajectory-val :lambda-list '(m))
(cl:defmethod trajectory-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:trajectory-val is deprecated.  Use lidar-msg:trajectory instead.")
  (trajectory m))

(cl:ensure-generic-function 'history_velocity-val :lambda-list '(m))
(cl:defmethod history_velocity-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:history_velocity-val is deprecated.  Use lidar-msg:history_velocity instead.")
  (history_velocity m))

(cl:ensure-generic-function 'history_type-val :lambda-list '(m))
(cl:defmethod history_type-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:history_type-val is deprecated.  Use lidar-msg:history_type instead.")
  (history_type m))

(cl:ensure-generic-function 'gps_mode-val :lambda-list '(m))
(cl:defmethod gps_mode-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:gps_mode-val is deprecated.  Use lidar-msg:gps_mode instead.")
  (gps_mode m))

(cl:ensure-generic-function 'gps_info-val :lambda-list '(m))
(cl:defmethod gps_info-val ((m <SupplementInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:gps_info-val is deprecated.  Use lidar-msg:gps_info instead.")
  (gps_info m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SupplementInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'polygon)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar-msg:Point3f))
