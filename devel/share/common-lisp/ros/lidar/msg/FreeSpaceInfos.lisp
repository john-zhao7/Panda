...
(cl:defmethod cl:initialize-instance :after ((m <FreeSpaceInfos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FreeSpaceInfos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<FreeSpaceInfos> is deprecated: use lidar-msg:FreeSpaceInfos instead.")))

(cl:ensure-generic-function 'fs_pts-val :lambda-list '(m))
(cl:defmethod fs_pts-val ((m <FreeSpaceInfos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:fs_pts-val is deprecated.  Use lidar-msg:fs_pts instead.")
  (fs_pts m))

(cl:ensure-generic-function 'fs_confidence-val :lambda-list '(m))
(cl:defmethod fs_confidence-val ((m <FreeSpaceInfos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar-msg:fs_confidence-val is deprecated.  Use lidar-msg:fs_confidence instead.")
  (fs_confidence m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FreeSpaceInfos>)))
  ...
  (cl:format cl:nil "Point3f[]        fs_pts~%std_msgs/Float32[] fs_confidence ~%~%================================================================================~%MSG: lidar/Point3f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FreeSpaceInfos)))
  "Returns full string definition for message of type 'FreeSpaceInfos"
  (cl:format cl:nil "Point3f[]        fs_pts~%std_msgs/Float32[] fs_confidence ~%~%================================================================================~%MSG: lidar/Point3f~%std_msgs/Float32 x ~%std_msgs/Float32 y ~%std_msgs/Float32 z ~%================================================================================~%MSG: std_msgs/Float32~%float32 data~%~%"))
