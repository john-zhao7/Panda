...
(cl:defclass <Objects> (roslisp-msg-protocol:ros-message)
  ((objects
    :reader objects
    :initarg :objects
    :type (cl:vector lidar-msg:Object)
   :initform (cl:make-array 0 :element-type 'lidar-msg:Object :initial-element (cl:make-instance 'lidar-msg:Object))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Objects>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Objects)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar-msg:<Objects> is deprecated: use lidar-msg:Objects instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Objects>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'lidar-msg:Object))
