...
"""autogenerated by genpy from lidar/LidarFrameMsg.msg. Do not edit."""
import codecs
import sys
...
class LidarFrameMsg(genpy.Message):
  _md5sum = "caa4cd6acb7dc86f4a76180c583c5946"
  _type = "lidar/LidarFrameMsg"
...
std_msgs/Float32 confidence 
"""
  __slots__ = ['frame_id','timestamp','global_pose','gps_origin','status_pose_map','status','valid_indices','objects','has_pointcloud','scan_pointcloud','has_attention_objects','attention_objects','has_freespace','freespace_infos','has_lanes','lanes','has_roadedges','roadedges','has_sematice_indices','non_ground_indices','ground_indices','background_indices']
  _slot_types = ['std_msgs/String','std_msgs/Float64','lidar/Pose','lidar/Point3d','lidar/PoseMap','std_msgs/Int32','lidar/Indices','lidar/Objects','std_msgs/Bool','lidar/Point4f[]','std_msgs/Bool','lidar/Objects','std_msgs/Bool','lidar/FreeSpaceInfos','std_msgs/Bool','lidar/Lanes','std_msgs/Bool','lidar/RoadEdges','std_msgs/Bool','lidar/Indices','lidar/Indices','lidar/Indices']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       frame_id,timestamp,global_pose,gps_origin,status_pose_map,status,valid_indices,objects,has_pointcloud,scan_pointcloud,has_attention_objects,attention_objects,has_freespace,freespace_infos,has_lanes,lanes,has_roadedges,roadedges,has_sematice_indices,non_ground_indices,ground_indices,background_indices
    ...
    """
    if args or kwds:
      super(LidarFrameMsg, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.frame_id is None:
        self.frame_id = std_msgs.msg.String()
      if self.timestamp is None:
        self.timestamp = std_msgs.msg.Float64()
      if self.global_pose is None:
        self.global_pose = lidar.msg.Pose()
      if self.gps_origin is None:
        self.gps_origin = lidar.msg.Point3d()
      if self.status_pose_map is None:
        self.status_pose_map = lidar.msg.PoseMap()
      if self.status is None:
        self.status = std_msgs.msg.Int32()
      if self.valid_indices is None:
        self.valid_indices = lidar.msg.Indices()
      if self.objects is None:
        self.objects = lidar.msg.Objects()
      if self.has_pointcloud is None:
        self.has_pointcloud = std_msgs.msg.Bool()
      if self.scan_pointcloud is None:
        self.scan_pointcloud = []
      if self.has_attention_objects is None:
        self.has_attention_objects = std_msgs.msg.Bool()
      if self.attention_objects is None:
        self.attention_objects = lidar.msg.Objects()
      if self.has_freespace is None:
        self.has_freespace = std_msgs.msg.Bool()
      if self.freespace_infos is None:
        self.freespace_infos = lidar.msg.FreeSpaceInfos()
      if self.has_lanes is None:
        self.has_lanes = std_msgs.msg.Bool()
      if self.lanes is None:
        self.lanes = lidar.msg.Lanes()
      if self.has_roadedges is None:
        self.has_roadedges = std_msgs.msg.Bool()
      if self.roadedges is None:
        self.roadedges = lidar.msg.RoadEdges()
      if self.has_sematice_indices is None:
        self.has_sematice_indices = std_msgs.msg.Bool()
      if self.non_ground_indices is None:
        self.non_ground_indices = lidar.msg.Indices()
      if self.ground_indices is None:
        self.ground_indices = lidar.msg.Indices()
      if self.background_indices is None:
        self.background_indices = lidar.msg.Indices()
    else:
      self.frame_id = std_msgs.msg.String()
      self.timestamp = std_msgs.msg.Float64()
      self.global_pose = lidar.msg.Pose()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_d6fi3d().pack(_x.timestamp.data, _x.global_pose.x.data, _x.global_pose.y.data, _x.global_pose.z.data, _x.global_pose.roll.data, _x.global_pose.pitch.data, _x.global_pose.yaw.data, _x.global_pose.status.data, _x.gps_origin.x.data, _x.gps_origin.y.data, _x.gps_origin.z.data))
      length = len(self.status_pose_map.status_poses)
      buff.write(_struct_I.pack(length))
      for val1 in self.status_pose_map.status_poses:
        _v1 = val1.status
        _x = _v1.data
      ...
      _x = self.status.data
      buff.write(_get_struct_i().pack(_x))
      length = len(self.valid_indices.indices)
      buff.write(_struct_I.pack(length))
      for val1 in self.valid_indices.indices:
        _x = val1.data
        buff.write(_get_struct_i().pack(_x))
      ...
      for val1 in self.objects.objects:
        ...
        _x = _v103.data
        buff.write(_get_struct_d().pack(_x))
      _x = self.has_pointcloud.data
      buff.write(_get_struct_B().pack(_x))
      length = len(self.scan_pointcloud)
      buff.write(_struct_I.pack(length))
      for val1 in self.scan_pointcloud:
        _v104 = val1.x
        _x = _v104.data
        buff.write(_get_struct_f().pack(_x))
        _v105 = val1.y
        ...
        _x = _v107.data
        buff.write(_get_struct_f().pack(_x))
      _x = self.has_attention_objects.data
      buff.write(_get_struct_B().pack(_x))
      length = len(self.attention_objects.objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.attention_objects.objects:
        _v108 = val1.coreinfo
        ...
        _x = _v201.data
        buff.write(_get_struct_d().pack(_x))
      _x = self.has_freespace.data
      buff.write(_get_struct_B().pack(_x))
      length = len(self.freespace_infos.fs_pts)
      buff.write(_struct_I.pack(length))
      for val1 in self.freespace_infos.fs_pts:
        _v202 = val1.x
        _x = _v202.data
        buff.write(_get_struct_f().pack(_x))
        _v203 = val1.y
        ...
        _x = _v204.data
        buff.write(_get_struct_f().pack(_x))
      length = len(self.freespace_infos.fs_confidence)
      buff.write(_struct_I.pack(length))
      for val1 in self.freespace_infos.fs_confidence:
        _x = val1.data
        buff.write(_get_struct_f().pack(_x))
      _x = self.has_lanes.data
      buff.write(_get_struct_B().pack(_x))
      length = len(self.lanes.lanes)
      buff.write(_struct_I.pack(length))
      for val1 in self.lanes.lanes:
        _v205 = val1.lane_id
        _x = _v205.data
        buff.write(_get_struct_i().pack(_x))
        _v206 = val1.curve
        ...
        _x = _v221.data
        buff.write(_get_struct_f().pack(_x))
      _x = self.has_roadedges.data
      buff.write(_get_struct_B().pack(_x))
      length = len(self.roadedges.curbs)
      buff.write(_struct_I.pack(length))
      for val1 in self.roadedges.curbs:
        ...
        _x = _v238.data
        buff.write(_get_struct_f().pack(_x))
      _x = self.has_sematice_indices.data
      buff.write(_get_struct_B().pack(_x))
      length = len(self.non_ground_indices.indices)
      buff.write(_struct_I.pack(length))
      for val1 in self.non_ground_indices.indices:
        _x = val1.data
        buff.write(_get_struct_i().pack(_x))
      length = len(self.ground_indices.indices)
      buff.write(_struct_I.pack(length))
      for val1 in self.ground_indices.indices:
        _x = val1.data
        buff.write(_get_struct_i().pack(_x))
      length = len(self.background_indices.indices)
      buff.write(_struct_I.pack(length))
      for val1 in self.background_indices.indices:
        _x = val1.data
        buff.write(_get_struct_i().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.frame_id.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.frame_id.data = str[start:end]
      _x = self
      start = end
      end += 60
      (_x.timestamp.data, _x.global_pose.x.data, _x.global_pose.y.data, _x.global_pose.z.data, _x.global_pose.roll.data, _x.global_pose.pitch.data, _x.global_pose.yaw.data, _x.global_pose.status.data, _x.gps_origin.x.data, _x.gps_origin.y.data, _x.gps_origin.z.data,) = _get_struct_d6fi3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.status_pose_map.status_poses = []
      for i in range(0, length):
        val1 = lidar.msg.AxisStatusPose()
        _v239 = val1.status
        start = end
        end += 4
        ...
        self.status_pose_map.status_poses.append(val1)
      start = end
      end += 4
      (self.status.data,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.valid_indices.indices.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.objects.objects = []
      for i in range(0, length):
        val1 = lidar.msg.Object()
        _v248 = val1.coreinfo
      ...
      (self.has_pointcloud.data,) = _get_struct_B().unpack(str[start:end])
      self.has_pointcloud.data = bool(self.has_pointcloud.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.scan_pointcloud = []
      for i in range(0, length):
        val1 = lidar.msg.Point4f()
        _v342 = val1.x
        start = end
        end += 4
        ...
        self.scan_pointcloud.append(val1)
      start = end
      end += 1
      (self.has_attention_objects.data,) = _get_struct_B().unpack(str[start:end])
      self.has_attention_objects.data = bool(self.has_attention_objects.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.attention_objects.objects = []
      for i in range(0, length):
        val1 = lidar.msg.Object()
        _v346 = val1.coreinfo
        ...
        self.attention_objects.objects.append(val1)
      start = end
      end += 1
      (self.has_freespace.data,) = _get_struct_B().unpack(str[start:end])
      self.has_freespace.data = bool(self.has_freespace.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.freespace_infos.fs_pts = []
      for i in range(0, length):
        val1 = lidar.msg.Point3f()
        _v440 = val1.x
        start = end
        end += 4
        ...
        self.freespace_infos.fs_pts.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.freespace_infos.fs_confidence = []
      for i in range(0, length):
        val1 = std_msgs.msg.Float32()
        start = end
        end += 4
        (val1.data,) = _get_struct_f().unpack(str[start:end])
        self.freespace_infos.fs_confidence.append(val1)
      start = end
      end += 1
      (self.has_lanes.data,) = _get_struct_B().unpack(str[start:end])
      self.has_lanes.data = bool(self.has_lanes.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.lanes.lanes = []
      for i in range(0, length):
        ...
        self.lanes.lanes.append(val1)
      start = end
      end += 1
      (self.has_roadedges.data,) = _get_struct_B().unpack(str[start:end])
      self.has_roadedges.data = bool(self.has_roadedges.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.roadedges.curbs = []
      for i in range(0, length):
        val1 = lidar.msg.RoadEdge()
        ...
        self.roadedges.curbs.append(val1)
      start = end
      end += 1
      (self.has_sematice_indices.data,) = _get_struct_B().unpack(str[start:end])
      self.has_sematice_indices.data = bool(self.has_sematice_indices.data)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.non_ground_indices.indices = []
      for i in range(0, length):
        val1 = std_msgs.msg.Int32()
        start = end
        end += 4
        (val1.data,) = _get_struct_i().unpack(str[start:end])
        self.non_ground_indices.indices.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (val1.data,) = _get_struct_i().unpack(str[start:end])
        self.ground_indices.indices.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.background_indices.indices = []
      for i in range(0, length):
        val1 = std_msgs.msg.Int32()
        start = end
        end += 4
        (val1.data,) = _get_struct_i().unpack(str[start:end])
        self.background_indices.indices.append(val1)
      return self
