...
"""autogenerated by genpy from lidar/EndPoints.msg. Do not edit."""
import codecs
import sys
...
float32 data"""
  __slots__ = ['start','end']
  _slot_types = ['lidar/Point2f','lidar/Point2f']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.start is None:
        self.start = lidar.msg.Point2f()
      if self.end is None:
        self.end = lidar.msg.Point2f()
    else:
      self.start = lidar.msg.Point2f()
      self.end = lidar.msg.Point2f()
