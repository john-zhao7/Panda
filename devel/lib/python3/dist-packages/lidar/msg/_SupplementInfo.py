...
"""autogenerated by genpy from lidar/SupplementInfo.msg. Do not edit."""
import codecs
import sys
...
float64 data"""
  ...
  _slot_types = ['std_msgs/UInt32','lidar/Point3f[]','std_msgs/Int32','std_msgs/Int32','std_msgs/Int32[]','std_msgs/Float32[]','std_msgs/Int32','std_msgs/Int32','std_msgs/Bool','std_msgs/Int32','lidar/Point3f','lidar/Point3f','lidar/Point3f[]','lidar/Point3f[]','std_msgs/Int32[]','std_msgs/Int32','lidar/Point3d']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.geo_center is None:
        self.geo_center = lidar.msg.Point3f()
      if self.geo_size is None:
        self.geo_size = lidar.msg.Point3f()
      ...
      if self.gps_info is None:
        self.gps_info = lidar.msg.Point3d()
    else:
      self.unique_id = std_msgs.msg.UInt32()
      self.polygon = []
      self.left_point_index = std_msgs.msg.Int32()
