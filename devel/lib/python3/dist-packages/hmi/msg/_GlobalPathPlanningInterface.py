...
"""autogenerated by genpy from hmi/GlobalPathPlanningInterface.msg. Do not edit."""
import codecs
import sys
...
class GlobalPathPlanningInterface(genpy.Message):
  _md5sum = "ec3972cc1c6335e1c2839cc4a004782b"
  _type = "hmi/GlobalPathPlanningInterface"
...
float64[] y_list
"""
  __slots__ = ['timestamp','startpoint','endpoint','routedata','process_time','Global_Path_Segment_Index','len_path','last_point','plan_over','x_list','y_list']
  _slot_types = ['float64','float64[]','float64[]','string[]','float32','int32','int32','float32[]','int8','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       timestamp,startpoint,endpoint,routedata,process_time,Global_Path_Segment_Index,len_path,last_point,plan_over,x_list,y_list
